...
<div class="flex-paragraph">
	<div style="display: flex; flex-wrap: wrap;" class="flex-container">
		<div style="flex: 1 1 40%; display: block;" class="card sgds">
			<img src="{{ '/images/Green%20Capsule%20Organics/green_capsule_organics_logo.png' | relative_url }}">
		</div>
...
<div style="display: flex; flex-wrap: wrap;">
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		<div style="display: block;" class="flex-image">
			<img src="{{ '/images/Green%20Capsule%20Organics/green_capsule_organics_product_01.jpg' | relative_url }}">
		</div>
		<div class="flex-paragraph">
	...
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		<div style="display: block;" class="flex-image">
			<img src="{{ '/images/Green%20Capsule%20Organics/green_capsule_organics_product_02.jpg' | relative_url }}">
		</div>
		<div class="flex-paragraph">
