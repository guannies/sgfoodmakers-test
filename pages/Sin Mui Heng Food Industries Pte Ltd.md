...
<div style="display: flex; flex-wrap: wrap;" class="flex-container">
	<div style="flex: 1 1 65%; display: block; align-self: stretch" class="card sgds">
		<div class="flex-paragraph">
			...
			<p>
				<b>Export Markets: </b>Australia, Barbados, Indonesia, South Korea, Mauritius, Netherlands, the Philippines, Saudi Arabia, United Kingdom, United Arab Emirates, Japan
			</p>
...
<div style="display: flex; flex-wrap: wrap;">
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		<div style="display: block;" class="flex-image">
			<img src="{{ '/images/Sin%20Mui%20Heng/sin_mui_heng_product_01.jpg' | relative_url }}">
		</div>
		<div class="flex-paragraph">
			<h6 style="text-transform: uppercase; color: black;">Chilli Crab Pau</h6>
			<p>A contemporary twist on Singapore Chilli Crab, best enjoyed fried-delivering the crispness of golden mantou paired with the tangy flavours of chilli crab. It can also be steamed for a soft and fluffy texture.</p>
		</div>
	</div>
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		<div style="display: block;" class="flex-image">
			<img src="{{ '/images/Sin%20Mui%20Heng/sin_mui_heng_product_02.jpg' | relative_url }}">
		</div>
		<div class="flex-paragraph">
			<h6 style="text-transform: uppercase; color: black;">Salted Egg Custard Pau</h6>
			<p>Sink your teeth into our signature molten egg custard, flowing luxuriously with every bite and delivering a rich, buttery sweet-savoury delight. A perfect mood-lifting treat to share with family and loved ones—irresistibly addictive!</p>
		</div>
	</div>
</div>